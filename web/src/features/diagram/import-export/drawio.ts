...
export function createDrawioXml(page: DiagramPage): string {
  ...
  return `<?xml version="1.0" encoding="UTF-8"?><mxfile host="ReasonAI" version="subset-1"><diagram name="${escapeXml(page.name)}"><mxGraphModel><root><mxCell id="0"/><mxCell id="1" parent="0"/>${vertices}${edges}</root></mxGraphModel></diagram></mxfile>`;
}
