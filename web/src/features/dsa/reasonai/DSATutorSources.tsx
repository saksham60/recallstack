...
export function DSATutorSources({ sources, cached }: { sources: DSATutorSource[]; cached?: boolean }) {
  ...
  return <div className="mt-4 border-t border-border/50 pt-3">
    <div className="mb-2 flex flex-wrap items-center justify-between gap-2 text-[10px] text-muted"><span className="uppercase tracking-wider">Sources{cached ? " · Retrieved earlier" : ""}</span><span>Powered by Tavily</span></div>
