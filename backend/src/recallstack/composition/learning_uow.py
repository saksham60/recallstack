...
from recallstack.modules.learning.application.learning_state import LearningStateRepository
...
class SqlAlchemyLearningUnitOfWork:
    def __init__(self, session_factory: DatabaseSessionFactory[AsyncSession]) -> None:
        ...
        self.repository: LearningStateRepository

    async def __aenter__(self) -> Self:
        self._session = self._session_factory.create_session()
        self.repository = SqlAlchemyLearningStateRepository(self._session)
        return self
