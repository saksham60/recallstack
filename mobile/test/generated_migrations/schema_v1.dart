...
class ContentItems extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class ContentDocuments extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ContentDocuments(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  ContentDocuments createAlias(String alias) {
    return ContentDocuments(attachedDatabase, alias);
  }
}

class UserProgress extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class UserNotes extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  UserNotes(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  UserNotes createAlias(String alias) {
    return UserNotes(attachedDatabase, alias);
  }
}

class ReviewCards extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ReviewCards(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  ReviewCards createAlias(String alias) {
    return ReviewCards(attachedDatabase, alias);
  }
}

class LocalOutbox extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  LocalOutbox(this.attachedDatabase, [this._alias]);
  ...
  @override
  LocalOutbox createAlias(String alias) {
    return LocalOutbox(attachedDatabase, alias);
  }
}
...
class DeviceState extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class DatabaseAtV1 extends GeneratedDatabase {
  ...
  late final ContentDocuments contentDocuments = ContentDocuments(this);
  late final UserProgress userProgress = UserProgress(this);
  late final Bookmarks bookmarks = Bookmarks(this);
  late final UserNotes userNotes = UserNotes(this);
  late final ReviewCards reviewCards = ReviewCards(this);
  late final LocalOutbox localOutbox = LocalOutbox(this);
