...
class AppColors {
  ...
  // Lilac / Lavender accents
  static const Color accent = Color(0xFF9381FF);
  static const Color accentLight = Color(0xFFB8B8FF);
  static const Color accentDark = Color(0xFF7B66FF);
